...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/scriptconfig/examples/demo_modal2.py --help
        python ~/code/scriptconfig/examples/demo_modal2.py bar --help
        python ~/code/scriptconfig/examples/demo_modal2.py bar --o f
        python ~/code/scriptconfig/examples/demo_modal2.py bar --o f
        python ~/code/scriptconfig/examples/demo_modal2.py f
    """
    MyModalCLI.main()
