...
"""
Installation:
    pip install git+https://github.com/Erotemic/scriptconfig.git
...
def parse_version(package):
    ...
    CommandLine:
        python -c "import setup; print(setup.parse_version('scriptconfig'))"
    """
...
version = parse_version('scriptconfig')  # needs to be a global var for git tags
