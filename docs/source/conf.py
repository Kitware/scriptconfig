...
Notes:
    ...
    sphinx-apidoc --private -f -o ~/code/scriptconfig/docs/source ~/code/scriptconfig/scriptconfig --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/scriptconfig/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/scriptconfig/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'scriptconfig', '__init__.py')
...
# html_logo = '.static/scriptconfig.svg'
# html_favicon = '.static/scriptconfig.ico'
...
latex_documents = [
    (master_doc, 'scriptconfig.tex', 'scriptconfig Documentation',
...
man_pages = [
    (master_doc, 'scriptconfig', 'scriptconfig Documentation',
     [author], 1)
]
