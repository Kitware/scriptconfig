...
def generate_typed_stubs():
    ...
    files = list(static_analysis.package_modpaths(modpath, recursive=True, with_libs=1, with_pkg=0))
...
class ExtendedStubGenerator(StubGenerator):
    ...
    def visit_func_def(self, o: FuncDef, is_abstract: bool = False,
        ...
        def _hack_for_info(info):
            ...
            if 'argparse.' in info['type']:
                self.add_import_line('import argparse\n')
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/scriptconfig/dev/gen_typed_stubs.py
    """
